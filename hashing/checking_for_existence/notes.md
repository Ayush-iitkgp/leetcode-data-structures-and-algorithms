...
This approach involves a **pre-processing step** where we iterate over the array and build a hash map that will be used for existence.
...
**Important:**
**Anytime you find your algorithm running into `if ... in ...`, use hash map or set**
